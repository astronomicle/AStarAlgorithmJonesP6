...
public class FindPathAStar : MonoBehaviour
{
    ...
    void BeginSearch()
    {
        ...
        goalNode = new PathMarker(new MapLocation(locations[1].x, locations[1].z), 0, 0, 0, Instantiate(end, startlocation, Quaternion.identity), null);
    }
